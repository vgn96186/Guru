...
**Current State**: In `src/screens/StatsScreen.tsx`, the `loadStats()` function fetches the _entire_ topics database into JS memory and loops through it synchronously.
