...
- If the exact answer to the user's question is not found in the extract, briefly state this, then proactively offer a related piece of information that _was_ found in the text.
