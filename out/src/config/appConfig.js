...
exports.FEATURE_TEXTURE = exports.MOCK_EXTERNAL_LECTURE_AUDIO_URL = exports.MOCK_EXTERNAL_LECTURE_AUDIO_ENABLED = exports.DEFAULT_HF_TRANSCRIPTION_MODEL = exports.GROQ_MODELS = exports.OPENROUTER_FREE_MODELS = exports.IMAGE_GENERATION_MODEL_OPTIONS = exports.DEFAULT_IMAGE_GENERATION_MODEL = exports.FAL_IMAGE_GENERATION_MODEL_OPTIONS = exports.FAL_IMAGE_MODEL_LABELS = exports.GEMINI_IMAGE_MODEL_LABELS = exports.OPENROUTER_IMAGE_MODELS = exports.FAL_IMAGE_MODELS = exports.GEMINI_IMAGE_MODELS = exports.CLOUDFLARE_IMAGE_MODEL = exports.CLOUDFLARE_IMAGE_MODELS = exports.CLOUDFLARE_MODELS = exports.GEMINI_STRUCTURED_JSON_MODELS = exports.GEMINI_MODELS = exports.CHATGPT_MODELS = exports.AGENTROUTER_MODELS = exports.KILO_MODELS = exports.DEEPSEEK_MODELS = exports.POE_MODELS = exports.GITLAB_DUO_MODELS = exports.GITHUB_COPILOT_MODELS = exports.GITHUB_MODELS_CHAT_MODELS = exports.GITHUB_MODELS_ORG = exports.GITHUB_MODELS_INFERENCE_ORIGIN = exports.GITHUB_MODELS_API_VERSION = exports.GOOGLE_WEB_CLIENT_ID = exports.G4F_PROXY_URL = exports.BUNDLED_GITHUB_MODELS_PAT = exports.BUNDLED_DEEPSEEK_KEY = exports.BUNDLED_BRAVE_SEARCH_KEY = exports.BUNDLED_FAL_KEY = exports.BUNDLED_CF_API_TOKEN = exports.BUNDLED_CF_ACCOUNT_ID = exports.BUNDLED_GEMINI_FALLBACK_KEY = exports.BUNDLED_GEMINI_KEY = exports.BUNDLED_OPENROUTER_KEY = exports.BUNDLED_HF_TOKEN = exports.BUNDLED_GROQ_KEY = exports.DEFAULT_NEET_DATE = exports.DEFAULT_INICET_DATE = void 0;
...
exports.DEFAULT_INICET_DATE = ((_a = process.env.EXPO_PUBLIC_DEFAULT_INICET_DATE) !== null && _a !== void 0 ? _a : '2026-05-17').trim() || '2026-05-17';
/** Default NEET-PG exam date (YYYY-MM-DD). Override via EXPO_PUBLIC_DEFAULT_NEET_DATE. */
exports.DEFAULT_NEET_DATE = ((_b = process.env.EXPO_PUBLIC_DEFAULT_NEET_DATE) !== null && _b !== void 0 ? _b : '2026-08-30').trim() || '2026-08-30';
function getExpoExtraString(key) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
    try {
        var Constants = require('expo-constants');
        var extra = (_q = (_o = (_k = (_h = (_e = (_c = (_b = (_a = Constants.default) === null || _a === void 0 ? void 0 : _a.expoConfig) === null || _b === void 0 ? void 0 : _b.extra) !== null && _c !== void 0 ? _c : (_d = Constants.expoConfig) === null || _d === void 0 ? void 0 : _d.extra) !== null && _e !== void 0 ? _e : (_g = (_f = Constants.default) === null || _f === void 0 ? void 0 : _f.manifest2) === null || _g === void 0 ? void 0 : _g.extra) !== null && _h !== void 0 ? _h : (_j = Constants.manifest2) === null || _j === void 0 ? void 0 : _j.extra) !== null && _k !== void 0 ? _k : (_m = (_l = Constants.default) === null || _l === void 0 ? void 0 : _l.manifest) === null || _m === void 0 ? void 0 : _m.extra) !== null && _o !== void 0 ? _o : (_p = Constants.manifest) === null || _p === void 0 ? void 0 : _p.extra) !== null && _q !== void 0 ? _q : null;
        return typeof (extra === null || extra === void 0 ? void 0 : extra[key]) === 'string' ? extra[key].trim() : '';
    }
    catch (_r) {
        return '';
    }
...
exports.G4F_PROXY_URL = (process.env.EXPO_PUBLIC_G4F_URL ||
    getExpoExtraString('g4fProxyUrl') ||
    '').trim();
// Project-level default so Google Drive sign-in works out-of-the-box on fresh installs.
var DEFAULT_GOOGLE_WEB_CLIENT_ID = '132201315043-443j8hva0nhoapt6j4brcdb9n57kb1rv.apps.googleusercontent.com';
/**
 ...
 */
exports.GOOGLE_WEB_CLIENT_ID = (process.env.EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID ||
    bundledEnv_1.BUNDLED_GOOGLE_WEB_CLIENT_ID ||
    getExpoExtraString('googleWebClientId') ||
    DEFAULT_GOOGLE_WEB_CLIENT_ID).trim();
/**
 ...
 */
exports.GITHUB_MODELS_API_VERSION = ((_c = process.env.EXPO_PUBLIC_GITHUB_MODELS_API_VERSION) !== null && _c !== void 0 ? _c : '2022-11-28').trim() || '2022-11-28';
/** Base host only (no path). Override if GitHub documents a new hostname. */
exports.GITHUB_MODELS_INFERENCE_ORIGIN = ((_d = process.env.EXPO_PUBLIC_GITHUB_MODELS_INFERENCE_ORIGIN) !== null && _d !== void 0 ? _d : 'https://models.github.ai').trim() ||
    'https://models.github.ai';
/** When set, requests use POST /orgs/{org}/inference/chat/completions instead of user-scoped URL. */
exports.GITHUB_MODELS_ORG = ((_e = process.env.EXPO_PUBLIC_GITHUB_MODELS_ORG) !== null && _e !== void 0 ? _e : '').trim();
function getGitHubModelsChatCompletionsUrl() {
    ...
    if (org)
        return "".concat(origin, "/orgs/").concat(org, "/inference/chat/completions");
...
function orderedGitHubCopilotModels(preferred) {
    ...
    var rest = exports.GITHUB_COPILOT_MODELS.filter(function (m) { return m !== p; });
...
function orderedGitLabDuoModels(preferred) {
    ...
    var rest = exports.GITLAB_DUO_MODELS.filter(function (m) { return m !== p; });
    return __spreadArray([p], rest, true);
}
...
exports.FAL_IMAGE_GENERATION_MODEL_OPTIONS = exports.FAL_IMAGE_MODELS.map(function (m) { return ({
    value: m,
...
exports.IMAGE_GENERATION_MODEL_OPTIONS = __spreadArray(__spreadArray([
    {
        value: exports.DEFAULT_IMAGE_GENERATION_MODEL,
        label: 'Auto (Gemini: Flash first → Pro → then Cloudflare)',
    }
], exports.GEMINI_IMAGE_MODELS.map(function (m) { return ({
    value: m,
    label: "Google \u2014 ".concat(exports.GEMINI_IMAGE_MODEL_LABELS[m]),
}); }), true), exports.CLOUDFLARE_IMAGE_MODELS.map(function (m) { return ({
    value: m,
...
function normalizeImageGenerationModel(raw) {
    ...
    var allowed = new Set(__spreadArray(__spreadArray(__spreadArray(__spreadArray([
        exports.DEFAULT_IMAGE_GENERATION_MODEL
    ], exports.FAL_IMAGE_MODELS, true), exports.GEMINI_IMAGE_MODELS, true), exports.CLOUDFLARE_IMAGE_MODELS, true), exports.OPENROUTER_IMAGE_MODELS, true));
...
exports.DEFAULT_HF_TRANSCRIPTION_MODEL = ((_f = process.env.EXPO_PUBLIC_DEFAULT_HF_TRANSCRIPTION_MODEL) !== null && _f !== void 0 ? _f : 'openai/whisper-large-v3').trim() ||
    'openai/whisper-large-v3';
/** Enable mock external lecture flow (browser audio instead of installed lecture apps). */
exports.MOCK_EXTERNAL_LECTURE_AUDIO_ENABLED = ['1', 'true', 'yes', 'on'].includes(((_g = process.env.EXPO_PUBLIC_MOCK_EXTERNAL_LECTURE_AUDIO) !== null && _g !== void 0 ? _g : '').trim().toLowerCase());
/** Audio URL opened in mock external lecture flow. */
exports.MOCK_EXTERNAL_LECTURE_AUDIO_URL = ((_h = process.env.EXPO_PUBLIC_MOCK_EXTERNAL_LECTURE_AUDIO_URL) !== null && _h !== void 0 ? _h : 'https://www.learningcontainer.com/wp-content/uploads/2020/02/Kalimba.mp3').trim() || 'https://www.learningcontainer.com/wp-content/uploads/2020/02/Kalimba.mp3';
