            ...
            return __generator(this, function (_b) {
              switch (_b.label) {
                ...
                case 2:
                  ...
                  if (!retryable || attempt === maxAttempts) throw e_1;
                  return [
                    4 /*yield*/,
                    new Promise(function (resolve) {
                      return setTimeout(resolve, baseDelayMs * attempt);
                    }),
                  ];
                case 3:
                  _b.sent();
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            db.withExclusiveTransactionAsync(function () {
        ...
        case 2:
          return [4 /*yield*/, db.isInTransactionAsync()];
        case 3:
          inTx = _a.sent();
          if (inTx) {
        ...
        case 11:
          ...
          if (__DEV__) console.warn('[DB] Rollback failed:', rollbackErr_1);
          return [3 /*break*/, 12];
        case 12:
          throw e_2;
        case 13:
...
function initDatabase() {
  return __awaiter(this, arguments, void 0, function (forceSeed) {
    ...
    return __generator(this, function (_a) {
      run = _globalDb.__GURU_DB_INIT_QUEUE__.then(function () {
        return initDatabaseInternal(forceSeed);
      });
    ...
    return __generator(this, function (_j) {
      switch (_j.label) {
        ...
        case 3:
          ...
          if (
            !(
              (oldInfo === null || oldInfo === void 0 ? void 0 : oldInfo.exists) &&
              !(newInfo === null || newInfo === void 0 ? void 0 : newInfo.exists)
            )
          )
            return [3 /*break*/, 6];
        ...
        case 7:
          ...
          return [3 /*break*/, 8];
        case 8:
          return [4 /*yield*/, SQLite.openDatabaseAsync(exports.DB_NAME)];
        case 9:
          _db = _j.sent();
        ...
        case 22:
          err_2 = _j.sent();
          if (__DEV__) console.warn('[DB] Failed to drop stale index:', sql, err_2);
          return [3 /*break*/, 23];
        case 23:
          _a++;
          return [3 /*break*/, 19];
        ...
        case 28:
          err_3 = _j.sent();
          if (__DEV__) console.warn('[DB] Failed to create index:', sql, err_3);
          return [3 /*break*/, 29];
        case 29:
          _b++;
          return [3 /*break*/, 25];
        case 30:
          return [4 /*yield*/, db.getFirstAsync('SELECT COUNT(*) as count FROM topics')];
        case 31:
          topicCountRes = _j.sent();
          topicCount =
            (_f =
              topicCountRes === null || topicCountRes === void 0 ? void 0 : topicCountRes.count) !==
              null && _f !== void 0
              ? _f
              : 0;
        ...
        case 44:
          ...
          currentVersion =
            (_g =
              versionRow === null || versionRow === void 0 ? void 0 : versionRow.user_version) !==
              null && _g !== void 0
              ? _g
              : 0;
          ...
          return [
            4 /*yield*/,
            db.execAsync('PRAGMA user_version = '.concat(migrations_1.LATEST_VERSION)),
          ];
        case 45:
          // Fresh install: schema already complete from CREATE TABLE; mark as up-to-date
          _j.sent();
          ...
          if (msg.includes('duplicate column name')) {
            ...
            if (__DEV__)
              console.log(
                '[DB] Migration '.concat(
                  m.version,
                  ' already applied (daily_agenda exists), skipping.',
                ),
              );
          } else {
            if (__DEV__) console.error('[DB] Migration failed:', m.version, m.sql, err_4);
            throw err_4;
          }
          return [3 /*break*/, 51];
        case 51:
          return [4 /*yield*/, db.execAsync('PRAGMA user_version = '.concat(m.version))];
        case 52:
          _j.sent();
          _j.label = 53;
        case 53:
          ...
          return [
            ...
            db.runAsync(
              ...
              [
                m.version,
                Math.floor(nowTs() / 1000),
                (_h = m.description) !== null && _h !== void 0 ? _h : '',
              ],
            ),
          ];
        case 54:
        ...
        case 62:
          err_5 = _j.sent();
          if (__DEV__) console.warn('[DB] Integrity repair failed:', sql, err_5);
          return [3 /*break*/, 63];
        case 63:
          _e++;
          return [3 /*break*/, 59];
        case 64:
          ...
          return [
            4 /*yield*/,
            db.execAsync('INSERT OR IGNORE INTO topic_progress (topic_id) SELECT id FROM topics'),
          ];
        case 65:
          // Ensure all topics (including vault seeds) have a progress row
          _j.sent();
        ...
        case 66:
          ...
          return [
            4 /*yield*/,
            db.getFirstAsync('SELECT id, groq_api_key FROM user_profile WHERE id = 1'),
          ];
        case 67:
          profile = _j.sent();
        ...
        case 0:
          return [
            ...
            Promise.resolve().then(function () {
              return require('../constants/syllabus/topics');
            }),
          ];
        case 1:
                  ...
                  switch (_d.label) {
                    ...
                    case 1:
                      ...
                      return [
                        4 /*yield*/,
                        db.runAsync(
                          'INSERT OR IGNORE INTO topics (subject_id, name, inicet_priority, estimated_minutes) VALUES '.concat(
                            placeholders,
                          ),
                          params,
                        ),
                    ...
                    case 7:
                      _d.sent();
                      withParent = TOPICS_SEED.filter(function (t) {
                        return t[4] !== undefined;
                      });
                      i = 0;
                      _d.label = 8;
                    case 8:
                      ...
                      return [
                        4 /*yield*/,
                        db.runAsync(
                          'INSERT INTO tmp_parent_mapping (subject_id, name, parent_name) VALUES '.concat(
                            placeholders,
                          ),
                          params,
                        ),
                ...
                return __generator(this, function (_b) {
                  switch (_b.label) {
                    ...
                    case 1:
                      ...
                      return [
                        ...
                        db.runAsync(
                          ...
                          [subjectId, name_3, priority, minutes],
                        ),
                      ];
                    case 2:
                      topicResult = _b.sent();
                    ...
                    case 4:
                      ...
                      return [
                        4 /*yield*/,
                        db.runAsync('INSERT OR IGNORE INTO topic_progress (topic_id) VALUES (?)', [
                          topicId,
                        ]),
                      ];
                    case 5:
                    ...
                    case 7:
                      ...
                      return [
                        4 /*yield*/,
                        db.runAsync(
                          "UPDATE topic_progress SET status = 'seen' WHERE topic_id IN (".concat(
                            placeholders,
                            ") AND status = 'unseen'",
                          ),
                          vaultTopicIds,
                    ...
                    case 8:
                      ...
                      return [
                        4 /*yield*/,
                        db.runAsync(
                          'UPDATE topic_progress SET confidence = 1 WHERE topic_id IN ('.concat(
                            placeholders,
                            ') AND confidence = 0',
                          ),
                          vaultTopicIds,
...
function seedUserProfile(db) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, db.runAsync('INSERT OR IGNORE INTO user_profile (id) VALUES (1)')];
        case 1:
          _a.sent();
          return [2 /*return*/];
      }
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
      switch (_f.label) {
        case 0:
          tables = {
            user_profile: [
              ...
              [
                'inicet_date',
                "TEXT NOT NULL DEFAULT '".concat(appConfig_1.DEFAULT_INICET_DATE, "'"),
              ],
              ...
              [
                'huggingface_transcription_model',
                "TEXT NOT NULL DEFAULT 'openai/whisper-large-v3'",
              ],
        ...
        case 3:
          tableCheck = _f.sent();
          if (!tableCheck || tableCheck.count === 0) return [3 /*break*/, 12];
          if (!/^[a-zA-Z_][a-zA-Z0-9_]*$/.test(tableName)) return [3 /*break*/, 12];
        ...
        case 5:
          ...
          if (!/^[a-zA-Z_][a-zA-Z0-9_]*$/.test(col)) return [3 /*break*/, 9];
          _f.label = 6;
        case 6:
          _f.trys.push([6, 8, , 9]);
          return [
            4 /*yield*/,
            db.execAsync(
              'ALTER TABLE '.concat(tableName, ' ADD COLUMN ').concat(col, ' ').concat(def),
            ),
          ];
        case 7:
          _f.sent();
        ...
        case 8:
          err_6 = _f.sent();
          if (
            !((_e = err_6 === null || err_6 === void 0 ? void 0 : err_6.message) === null ||
            _e === void 0
              ? void 0
              : _e.includes('duplicate column name'))
          ) {
            if (__DEV__)
              console.error(
                '[DB] Failed to add column '.concat(tableName, '.').concat(col, ':'),
                err_6,
              );
          }
          return [3 /*break*/, 9];
        ...
        case 13:
          if (totalAdded > 0 && !__DEV__) {
            console.log(
              '[DB] Recovered '.concat(totalAdded, ' missing column(s) across standard tables'),
            );
          }
          return [2 /*return*/];
      }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            db.runAsync('UPDATE user_profile SET streak_current = 0 WHERE id = 1'),
          ];
        case 2:
          // Streak broken
          _a.sent();
