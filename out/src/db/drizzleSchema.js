...
exports.migrationHistory = exports.userContentFlags = exports.contentFactChecks = exports.mindMapEdges = exports.mindMapNodes = exports.mindMaps = exports.lectureScheduleProgress = exports.questionBank = exports.topicSuggestions = exports.planEvents = exports.dailyAgenda = exports.offlineAiQueue = exports.generatedStudyImages = exports.chatHistory = exports.externalAppLogs = exports.brainDumps = exports.guruChatThreads = exports.guruChatSessionMemory = exports.userProfile = exports.aiCache = exports.dailyLog = exports.lectureLearnedTopics = exports.lectureNotes = exports.sessions = exports.topicProgress = exports.topics = exports.subjects = void 0;
...
exports.topics = (0, sqlite_core_1.sqliteTable)('topics', {
    ...
    subjectNameUnique: (0, sqlite_core_1.uniqueIndex)('topics_subject_name_unique').on(table.subjectId, table.name),
}); });
...
exports.lectureLearnedTopics = (0, sqlite_core_1.sqliteTable)('lecture_learned_topics', {
    id: (0, sqlite_core_1.integer)('id').primaryKey({ autoIncrement: true }),
    ...
    lectureTopicUnique: (0, sqlite_core_1.uniqueIndex)('llt_lecture_topic_unique').on(table.lectureNoteId, table.topicId),
}); });
...
exports.aiCache = (0, sqlite_core_1.sqliteTable)('ai_cache', {
    id: (0, sqlite_core_1.integer)('id').primaryKey({ autoIncrement: true }),
    topicId: (0, sqlite_core_1.integer)('topic_id').notNull(),
    ...
    topicContentUnique: (0, sqlite_core_1.uniqueIndex)('ai_cache_topic_content_unique').on(table.topicId, table.contentType),
}); });
exports.userProfile = (0, sqlite_core_1.sqliteTable)('user_profile', {
    ...
    inicetDate: (0, sqlite_core_1.text)('inicet_date').notNull().default(appConfig_1.DEFAULT_INICET_DATE),
    neetDate: (0, sqlite_core_1.text)('neet_date').notNull().default(appConfig_1.DEFAULT_NEET_DATE),
    preferredSessionLength: (0, sqlite_core_1.integer)('preferred_session_length').notNull().default(45),
    ...
    transcriptionProvider: (0, sqlite_core_1.text)('transcription_provider').notNull().default('auto'),
    studyResourceMode: (0, sqlite_core_1.text)('study_resource_mode').notNull().default('hybrid'),
    subjectLoadOverridesJson: (0, sqlite_core_1.text)('subject_load_overrides_json').notNull().default('{}'),
    ...
    pomodoroIntervalMinutes: (0, sqlite_core_1.integer)('pomodoro_interval_minutes').notNull().default(20),
    ...
    googleCustomSearchApiKey: (0, sqlite_core_1.text)('google_custom_search_api_key').notNull().default(''),
    qwenConnected: (0, sqlite_core_1.integer)('qwen_connected').notNull().default(0),
    guruChatDefaultModel: (0, sqlite_core_1.text)('guru_chat_default_model').notNull().default('auto'),
    ...
    preferGeminiStructuredJson: (0, sqlite_core_1.integer)('prefer_gemini_structured_json').notNull().default(1),
    ...
    chatgptAccountsJson: (0, sqlite_core_1.text)('chatgpt_accounts_json')
        .notNull()
        .default('{"primary":{"enabled":true,"connected":false},"secondary":{"enabled":false,"connected":false}}'),
    ...
    githubCopilotConnected: (0, sqlite_core_1.integer)('github_copilot_connected').notNull().default(0),
    githubCopilotPreferredModel: (0, sqlite_core_1.text)('github_copilot_preferred_model').notNull().default(''),
    ...
    gitlabDuoPreferredModel: (0, sqlite_core_1.text)('gitlab_duo_preferred_model').notNull().default(''),
    ...
    homeNoveltyCooldownHours: (0, sqlite_core_1.integer)('home_novelty_cooldown_hours').notNull().default(6),
    ...
    autoRepairLegacyNotesEnabled: (0, sqlite_core_1.integer)('auto_repair_legacy_notes_enabled').notNull().default(0),
    scanOrphanedTranscriptsEnabled: (0, sqlite_core_1.integer)('scan_orphaned_transcripts_enabled').notNull().default(0),
});
exports.guruChatSessionMemory = (0, sqlite_core_1.sqliteTable)('guru_chat_session_memory', {
    ...
    messagesAtLastSummary: (0, sqlite_core_1.integer)('messages_at_last_summary').notNull().default(0),
});
...
exports.topicSuggestions = (0, sqlite_core_1.sqliteTable)('topic_suggestions', {
    id: (0, sqlite_core_1.integer)('id').primaryKey({ autoIncrement: true }),
    subjectId: (0, sqlite_core_1.integer)('subject_id').notNull(),
    name: (0, sqlite_core_1.text)('name').notNull(),
    ...
    subjectNormalizedUnique: (0, sqlite_core_1.uniqueIndex)('topic_suggestions_unique').on(table.subjectId, table.normalizedName),
}); });
...
exports.lectureScheduleProgress = (0, sqlite_core_1.sqliteTable)('lecture_schedule_progress', {
    id: (0, sqlite_core_1.integer)('id').primaryKey({ autoIncrement: true }),
    ...
    batchLectureUnique: (0, sqlite_core_1.uniqueIndex)('lecture_schedule_batch_lecture_unique').on(table.batchId, table.lectureIndex),
}); });
exports.mindMaps = (0, sqlite_core_1.sqliteTable)('mind_maps', {
    ...
    subjectId: (0, sqlite_core_1.integer)('subject_id'),
    topicId: (0, sqlite_core_1.integer)('topic_id'),
    viewportJson: (0, sqlite_core_1.text)('viewport_json').notNull().default('{"x":0,"y":0,"scale":1}'),
    createdAt: (0, sqlite_core_1.integer)('created_at').notNull(),
    updatedAt: (0, sqlite_core_1.integer)('updated_at').notNull(),
});
