...
exports.MIGRATIONS = [
    ...
    {
        version: 35,
        sql: "ALTER TABLE user_profile ADD COLUMN inicet_date TEXT NOT NULL DEFAULT '".concat(appConfig_1.DEFAULT_INICET_DATE, "'"),
    },
    {
        version: 36,
        sql: "ALTER TABLE user_profile ADD COLUMN neet_date TEXT NOT NULL DEFAULT '".concat(appConfig_1.DEFAULT_NEET_DATE, "'"),
    },
    ...
    {
        version: 46,
        sql: "UPDATE user_profile SET inicet_date = '".concat(appConfig_1.DEFAULT_INICET_DATE, "' WHERE inicet_date IS NULL OR inicet_date = '' OR inicet_date = '2026-05-01'"),
    },
    {
        version: 47,
        sql: "UPDATE user_profile SET neet_date = '".concat(appConfig_1.DEFAULT_NEET_DATE, "' WHERE neet_date IS NULL OR neet_date = '' OR neet_date = '2026-08-01'"),
    },
    {
        version: 48,
