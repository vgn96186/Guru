...
Object.defineProperty(exports, "mapConfidenceToRating", { enumerable: true, get: function () { return fsrsHelpers_1.mapConfidenceToRating; } });
...
function fsrsStatusFromCard(card) {
    if (card.state === ts_fsrs_1.State.Learning || card.state === ts_fsrs_1.State.Relearning)
        return 'seen';
    if (card.state === ts_fsrs_1.State.Review && card.stability >= 21)
        return 'mastered';
    return 'reviewed';
}
