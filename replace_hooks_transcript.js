...
// remove sortedFiles useMemo
content = content.replace(/  const sortedFiles = useMemo\(\(\) => \{[\s\S]*?  \}, \[files, sortBy\]\);\n\n/, '');

// remove selection methods
content = content.replace(/  const toggleSelection = useCallback[\s\S]*?  \}, \[\]\);\n\n/, '');
