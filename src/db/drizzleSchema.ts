...
export const userProfile = sqliteTable('user_profile', {
  ...
  streakShieldAvailable: integer('streak_shield_available', { mode: 'boolean' })
    .notNull()
    .default(true),
  bodyDoublingEnabled: integer('body_doubling_enabled', { mode: 'boolean' })
    .notNull()
    .default(true),
  ...
  visualTimersEnabled: integer('visual_timers_enabled', { mode: 'boolean' })
    .notNull()
    .default(false),
  faceTrackingEnabled: integer('face_tracking_enabled', { mode: 'boolean' })
    .notNull()
    .default(false),
  ...
  useNano: integer('use_nano', { mode: 'boolean' }).notNull().default(true),
  ...
  preferGeminiStructuredJson: integer('prefer_gemini_structured_json', { mode: 'boolean' })
    .notNull()
    .default(true),
  ...
  githubCopilotConnected: integer('github_copilot_connected', { mode: 'boolean' })
    .notNull()
    .default(false),
