    ...
    return (
      <SafeAreaView style={styles.safeError}>
        <View style={styles.container}>
          ...
          <Text style={styles.titleError}>BREAK IS OVER</Text>
          <Text style={styles.subError}>Time to get back to your lecture.</Text>
          <Text style={styles.warning}>Notifications will keep firing until the tablet signals that you're watching again.</Text>
          <TouchableOpacity style={styles.manualResumeBtn} onPress={handleReturnToLecture}>
            <Text style={styles.manualResumeBtnText}>↩ Resume (no tablet signal)</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.manualResumeBtn} onPress={handleReturnToLecture}>
          <Text style={styles.manualResumeBtnText}>↩ Resume now (skip sync)</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
