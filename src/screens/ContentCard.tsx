...
const s = StyleSheet.create({
  ...
  paragraphBox: { backgroundColor: '#1A1A24', borderRadius: theme.radius.xl, padding: theme.spacing.xl, marginBottom: theme.spacing.lg },
  ...
  clueNum: { color: '#6C63FF', fontSize: 11, fontWeight: '700', marginBottom: theme.spacing.xs },
