...
const s = StyleSheet.create({
  scroll: { flex: 1 },
  container: { padding: theme.spacing.xl, paddingBottom: 60 },
  cardType: {
    color: '#6C63FF',
    fontSize: 11,
    fontWeight: '700',
  ...
  pointsContainer: { marginBottom: theme.spacing.lg },
  pointRow: { flexDirection: 'row', marginBottom: theme.spacing.md },
  ...
  hookLabel: { color: '#6C63FF', fontSize: 11, fontWeight: '700', marginBottom: theme.spacing.xs },
  ...
  ratingContainer: { marginTop: theme.spacing.lg, marginBottom: 10 },
  ...
  expansionList: { marginBottom: theme.spacing.lg },
  ...
  paragraphBox: { backgroundColor: '#1A1A24', borderRadius: theme.radius.xl, padding: 16, marginBottom: theme.spacing.lg },
  paragraphText: { color: '#E0E0E0', fontSize: 15, lineHeight: 24 },
  clueBox: { backgroundColor: '#1A1A24', borderRadius: theme.radius.xl, padding: theme.spacing.lg, marginBottom: theme.spacing.sm },
