  ...
  return (
    <View style={funnelStyles.funnelCard}>
      ...
      <View style={funnelStyles.funnelLegendRow}>
        <LinearText style={[funnelStyles.funnelLegendItem, { color: n.colors.success }]}>
          {summary.masteredCount}
        </LinearText>
        <LinearText style={[funnelStyles.funnelLegendItem, { color: n.colors.warning }]}>
          {summary.reviewedCount}
        </LinearText>
        <LinearText style={[funnelStyles.funnelLegendItem, { color: n.colors.accent }]}>
          {summary.seenNeedingQuizCount}
        </LinearText>
        <LinearText style={[funnelStyles.funnelLegendItem, { color: n.colors.textMuted }]}>
          {summary.unseenCount}
        </LinearText>
      </View>
    </View>
