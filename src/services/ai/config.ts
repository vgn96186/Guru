import { OPENROUTER_FREE_MODELS, GROQ_MODELS, BUNDLED_GROQ_KEY } from '../../config/appConfig';

export { OPENROUTER_FREE_MODELS, GROQ_MODELS, BUNDLED_GROQ_KEY };
...
export function getApiKeys(profile?: { openrouterKey?: string; groqApiKey?: string } | null): { orKey: string | undefined; groqKey: string | undefined } {
  if (!profile) {
    return { orKey: undefined, groqKey: BUNDLED_GROQ_KEY || undefined };
  }
  return {
