 ...
 *
 * Each factory takes the auth material and returns a LanguageModel. For
...
export function createDeepSeekModel(opts: { modelId: string; apiKey: string }): LanguageModel {
  return createOpenAICompatibleModel({
    provider: 'deepseek',
    modelId: opts.modelId,
