...
try {
  ...
  `);
  console.log('getAllTopicsWithProgress is valid');
} catch(e) {
  console.error('getAllTopicsWithProgress FAILED:', e.message);
}
...
try {
  ...
  `);
  console.log('getAllSubjects is valid');
} catch(e) {
  console.error('getAllSubjects FAILED:', e.message);
}
